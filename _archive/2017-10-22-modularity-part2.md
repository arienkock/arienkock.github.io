...
subtitle: "what does a module look like"
date: 2017-10-22
original_url: /2017/10/22/Modularity-part2.html
---
[Part 1](/archive/2017-09-03-modularity-part1/) | Part 2

A module, as a logical unit, can be implemented in any number of ways. Its _form_ is simply "some code with a public interface". Which includes, but is not limited to:
...
Notice the words "parts" and "construct". Modules are meant to be part of a bigger thing. You're _supposed_ to build things with them. In short: a module has connecting bits. 
